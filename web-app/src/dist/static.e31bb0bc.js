...
},{}],"../node_modules/@metamask/onboarding/dist/metamask-onboarding.es.js":[function(require,module,exports) {
"use strict";
...
var Onboarding = /** @class */function () {
  ...
  Onboarding._detectBrowser = function () {
    var browserInfo = _bowser.default.parse(window.navigator.userAgent);
...
},{"bowser":"../node_modules/bowser/es5.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var player = document.querySelector(".success-anim");
var onboarding = new _onboarding.default();
var btn = document.querySelector(".onboard");
var mainPageBtn = document.querySelector(".main-page");
var statusText = document.querySelector("h1");
var statusDesc = document.querySelector(".desc");
...
var connected = function connected(accounts) {
...
function _connectWallet() {
  _connectWallet = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
...
var onClickInstallMetaMask = function onClickInstallMetaMask() {
...
var MetaMaskClientCheck = function MetaMaskClientCheck() {
  if (!isMetaMaskInstalled()) {
    ...
    connectWallet().then(function (accounts) {
...
MetaMaskClientCheck();
},{"@metamask/onboarding":"../node_modules/@metamask/onboarding/dist/metamask-onboarding.es.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
